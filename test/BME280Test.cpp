...
TEST_F(BME280Test, configuration_encodes_correctly) {
  // This test is not exhaustive to all combinations of configuration parameters
  // and their correct encoding. It only verifies the basic structure and
  // examplary correct encoding.
  auto const config =
